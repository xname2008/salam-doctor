        ...
        return (
          <button
            ...
            className={cn(
              ...
              selected
                ? "border-azure bg-azure-tint shadow-soft-sm"
                : "border-border bg-white hover:border-azure/40 hover:bg-surface",
              disabled && "cursor-not-allowed opacity-60",
            )}
          >
            {selected ? (
              <span className="absolute end-3 top-3 flex size-5 items-center justify-center rounded-full bg-azure text-white">
            ...
            <span
              className={cn(
                ...
                selected ? "bg-azure text-white" : "bg-surface text-azure",
              )}
            >
