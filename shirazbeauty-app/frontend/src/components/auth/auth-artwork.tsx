...
export function AuthArtwork() {
  return (
    <div className="relative hidden overflow-hidden bg-gradient-azure lg:flex lg:flex-col lg:justify-between lg:p-12">
      <div aria-hidden className="pointer-events-none absolute inset-0 opacity-25">
        <svg className="size-full" viewBox="0 0 400 600" fill="none" preserveAspectRatio="xMidYMid slice">
          ...
          {/* Abstract "petal" motif echoing the brand monogram. */}
          <path
