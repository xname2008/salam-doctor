...
const HUB_ENTRIES = [
  ...
  { slug: 'rhinoplasty', name: 'جراحی بینی', keywords: ['رینوپلاستی', 'جراحی بینی', 'بینی', 'rhinoplasty'] },
  { slug: 'lasik', name: 'لیزیک', keywords: ['لیزیک', 'lasik'] },
  { slug: 'femto-lasik', name: 'فمتولیزیک', keywords: ['فمتولیزیک', 'فمتو', 'femto'] },
  { slug: 'prk', name: 'پی‌آر‌کی', keywords: ['prk', 'پی آر کی', 'پی‌آر‌کی'] },
  { slug: 'pharmacy', name: 'داروخانه', keywords: ['داروخانه', 'دارو', 'مکمل', 'pharmacy'] },
  { slug: 'dentistry', name: 'دندانپزشکی', keywords: ['دندان', 'دندانپزشک', 'dental', 'ایمپلنت', 'implant', 'ارتودنسی', 'بریس', 'لمینت', 'کامپوزیت', 'veneer'] },
