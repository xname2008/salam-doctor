...
const SERVICE_LANDINGS = {
  ...
  'light-therapy': {
    label: 'نور درمانی',
    title: 'نور درمانی (لایت تراپی) در شیراز',
    description:
      'راهنمای نور درمانی و لایت تراپی در شیراز: کاربرد در جوانسازی پوست، لک و التهاب. معرفی مراکز مرتبط پوست و زیبایی و مشاوره رایگان سلام دکتر.',
