...
function OverviewBody({ stats }: { stats: ClinicStatsResponse }) {
  return (
    <>
      ...
      <section className="mt-10 overflow-hidden rounded-3xl border border-rose/12 bg-white shadow-soft">
        <div className="flex items-center justify-between border-b border-rose/10 bg-gradient-to-l from-rose-tint/70 to-white px-5 py-4">
          <div>
        ...
        {stats.upcoming.length === 0 ? (
          ...
          <ul className="divide-y divide-border">
            {stats.upcoming.map((row) => (
              ...
              >
                <span className="flex w-16 shrink-0 flex-col items-center rounded-2xl bg-rose-tint py-2 text-rose">
