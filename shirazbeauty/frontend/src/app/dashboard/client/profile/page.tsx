        ...
        <aside className="space-y-6">
          <div className="rounded-2xl border border-border bg-white p-6 text-center shadow-soft-sm">
            <div className="relative mx-auto w-fit">
              ...
              <button
                ...
                className="absolute -bottom-1 -start-1 flex size-9 items-center justify-center rounded-xl border border-border bg-white text-rose shadow-soft-sm transition-colors hover:bg-rose-tint"
              >
          ...
          <div className="rounded-2xl border border-border bg-white p-6 shadow-soft-sm">
            <div className="flex items-center gap-2">
              <BellRing className="size-4 text-rose" />
