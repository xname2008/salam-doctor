        ...
        <>
          ...
          <section className="mt-10 grid gap-6 xl:grid-cols-[1.6fr_1fr]">
            <div>
              <div className="mb-4 flex items-center justify-between">
                ...
                <Link
                  ...
                  className="flex items-center gap-1.5 text-xs text-rose transition-colors hover:text-rose-dark"
                >
                  مشاهده همه
            ...
            <aside className="space-y-6">
              <div className="rounded-2xl border border-rose/12 bg-white p-5 shadow-soft-sm">
                <h2 className="text-base font-bold text-ink">آخرین مراجعات</h2>
                {completed.length ? (
                  <ul className="mt-4 space-y-4">
                    {completed.slice(0, 4).map((item) => (
                      <li key={item.id} className="flex items-start gap-3">
                        <span className="mt-1 flex size-8 shrink-0 items-center justify-center rounded-xl bg-rose-tint text-rose">
              ...
              <div className="overflow-hidden rounded-2xl bg-gradient-rose p-6 text-white shadow-rose">
                ...
                <Button
                  ...
                  variant="soft"
                  size="sm"
                  className="mt-5 bg-white text-rose hover:bg-white/90"
                >
                  <Link href="/dashboard/client/book">
                    رزرو نوبت
                    <ArrowLeft />
