  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
      <div className="space-y-6">
        <Card className="overflow-hidden border-rose/12 shadow-soft">
          <CardHeader className="bg-gradient-to-l from-rose-tint/80 to-white">
            <p className="text-[11px] font-bold tracking-wide text-rose">مرحله ۱</p>
        ...
        <Card className="overflow-hidden border-rose/12 shadow-soft">
          <CardHeader>
            <p className="text-[11px] font-bold tracking-wide text-rose">مرحله ۲</p>
      ...
      <aside className="space-y-6 xl:sticky xl:top-24 xl:self-start">
        <Card className="border-rose/12 shadow-soft">
          <CardHeader>
            <p className="text-[11px] font-bold tracking-wide text-rose">مرحله ۳</p>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        active
                          ...
                          : "border border-border bg-white text-ink hover:border-rose/50 hover:bg-rose-tint hover:text-rose-dark",
                      )}
                    >
        ...
        <div className="overflow-hidden rounded-3xl border border-rose/15 bg-white shadow-soft">
          <div className="bg-gradient-rose px-6 py-5 text-white">
  ...
  return (
    <div className="flex items-start justify-between gap-4">
      ...
      <span className="flex items-center gap-1.5 text-end font-semibold text-ink">
        {Icon ? <Icon className="size-3.5 text-rose" /> : null}
        {value}
      </span>
    </div>
  );
