...
export default async function ClinicsDirectoryPage({
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-hero pb-8 pt-10 sm:pb-10 sm:pt-14">
        <div
          aria-hidden
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute -start-24 top-0 size-96 rounded-full bg-rose-tint blur-3xl"
        />
