      ...
      <div className="flex h-20 shrink-0 items-center gap-3 border-b border-border px-6">
        <Link href="/" className="flex items-center gap-3" onClick={onNavigate}>
          ...
          <span className="flex flex-col leading-none">
            ...
            <span className="mt-1 text-[10px] font-medium text-rose">{panelLabel}</span>
          </span>
        </Link>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? "bg-rose-tint text-rose shadow-soft-sm"
            ...
            >
              <span
                className={cn(
                  ...
                  active
                    ? "bg-rose text-white"
                    : "bg-surface text-ink-muted group-hover:text-rose",
                )}
              >
