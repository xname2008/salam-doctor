      ...
      <div className="flex items-center justify-between">
        ...
        <div className="text-center">
          ...
          <button
            ...
            className="mt-1 text-[11px] text-rose transition-colors hover:text-rose-dark"
          >
            برو به امروز
          </button>
        </div>
                ...
                selected
                  ...
                  : blocked
                    ...
                    : cell.isPast
                      ...
                      : "text-ink hover:bg-rose-tint hover:text-rose",
                cell.isToday && !selected && "ring-1 ring-rose/50",
              )}
            >
