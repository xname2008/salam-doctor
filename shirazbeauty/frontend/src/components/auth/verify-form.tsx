...
export function VerifyForm({ mobile, role, nextPath = null }: VerifyFormProps) {
  ...
  return (
    <div className="animate-fade-up">
      ...
      <span className="mt-8 flex size-12 items-center justify-center rounded-2xl bg-rose-tint text-rose">
      ...
      <div className="mt-8 flex items-center justify-center gap-2 text-xs text-ink-muted">
        {secondsLeft > 0 ? (
          ...
          <button
            ...
            disabled={resending}
            className="inline-flex items-center gap-2 font-semibold text-rose transition-colors hover:text-rose-dark disabled:opacity-60"
          >
            {resending ? (
